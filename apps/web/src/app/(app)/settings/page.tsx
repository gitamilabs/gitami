          ...
          <div className="space-y-6 animate-fade-in">
            <div className="bg-[#0c0c10] border border-zinc-800/90 rounded-2xl p-6 shadow-sm space-y-4">
              ...
              <p className="text-xs text-zinc-400 leading-relaxed">
                Live runtime inspection of active vector databases, embedder models, and dual-LLM configurations loaded from <code className="text-zinc-300 font-mono">apps/ai/.env</code>.
              </p>
