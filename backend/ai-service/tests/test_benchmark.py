...
from ai_service.benchmark.datasets.base import BenchmarkTestCase, GroundTruthIssue
from ai_service.benchmark.datasets.vulngym_adapter import parse_line_span
from ai_service.benchmark.scorer import (
    BenchmarkScorer,
    files_match,
    jaccard_similarity,
)
from ai_service.benchmark.report import (
...
async def test_runner_orchestration(tmp_path: Path, monkeypatch):
    ...
    from ai_service.benchmark.runner import BenchmarkRunner
    from ai_service.agent.reviewer import AgentReviewResult
    from ai_service.analysis.decision import DecisionResult
    ...
    with patch("ai_service.benchmark.runner.Neo4jClient") as mock_neo_cls, \
         patch("ai_service.benchmark.runner.VectorKBClient") as mock_vec_cls, \
         patch("ai_service.benchmark.runner.run_agentic_pr_review") as mock_review, \
         patch("ai_service.benchmark.runner.get_dataset") as mock_get_ds:
